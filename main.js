...
//initialize a thingspeakclient
var thingspeakclient = require('thingspeakclient');

// set timeout interval
var client = new thingspeakclient({updateTimeout:20000});

// attach the write key
client.attachChannel(51269, {writeKey:'HBPZNQWZ8P14ZUBT'});
...
// Upload the data values to the thingspeak cloud!
function uploadPower(){
	client.updateChannel(51269, {field1:power}, function(err,resp){
		if(!err && resp > 0){
			console.log('update successfullly Entry number was: ' +resp);
		}
	}
	);
}
